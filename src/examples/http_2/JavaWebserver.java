 ...
 * @version 0.1 Licence: GPL 3.0 or higher file: JavaWebserver.java
 */
public abstract class JavaWebserver extends Thread {
	...
	public void run() {
		 ...
		 */
		while (runMode && !isInterrupted() && !serversocket.isClosed()) {
...
//		System.out.println("JavaWebserver: RUNMODE GESETZT AUF: "+runMode);
